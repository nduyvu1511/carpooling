...
export const PromotionInfoItem = () => {
  ...
  return (
    <div onClick={() => router.push(`/promotion/${1}`)} className="relative rounded-[10px]">
      ...
      <div className="border border-solid border-blue-20   border-t-0 p-16 rounded-bl-[10px] rounded-br-[10px]">
        <Link href={`/promotion/1`}>
          <a className="text-center text-14 md:text-18 line-clamp-2 font-semibold text-primary leading-[20opx] md:leading-[24px] mb-16">
