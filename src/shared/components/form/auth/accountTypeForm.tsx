    ...
    <div className="">
      <div className="flex flex-col items-start sm:flex-row sm:items-stretch mb-[40px]">
        {[
          ...
          value === 'separate' ? (
            <div
              key={index}
              className="sm:mx-[32px] my-16 sm:my-[50px] border-r border-solid border-border-color"
            ></div>
          ) : (
            <div
              key={index}
      ...
      <div className="flex items-start mt-[24px] bg-orange-05 rounded-[5px] p-8">
        ...
        <p className="text-12 leading-[18px] flex-1 text-warning">
          Vui lòng chọn đúng loại tài khoản, mỗi số điện thoại chỉ có thể đăng ký một tài
          khoản.{' '}
        </p>
      </div>
