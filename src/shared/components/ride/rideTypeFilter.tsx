...
const RideTypeFilter = ({
  ...
  return (
    <div
      className={`flex items-center justify-between mb-[9px] sticky xl:static top-[60px] md:top-[80px] bg-white-color z-[1000] mx-[-12px] md:mx-[-16px] lg:mx-[-24px] px-custom py-12 shadow-shadow-1 xl:shadow-none`}
    >
